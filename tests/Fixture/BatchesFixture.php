...
class BatchesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'step_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'business_key_batches' => ['type' => 'index', 'columns' => ['business_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'batches_ibfk_5' => ['type' => 'foreign', 'columns' => ['business_id'], 'references' => ['businesses', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'quantity' => 1,
                'yield' => 1,
                'plant_date' => '2020-02-28 16:24:40',
                'harvest_date' => '2020-02-28 16:24:40',
                'watched' => 1,
                'testing_status' => 1,
                'testing_date' => '2020-02-28 16:24:40',
                'resource_path' => 'Lorem ipsum dolor sit amet',
                'created' => '2020-02-28 16:24:40',
                'modified' => '2020-02-28 16:24:40',
            ],
        ];
        parent::init();
    }
