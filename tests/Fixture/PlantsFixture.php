...
class PlantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'business_key_plants' => ['type' => 'index', 'columns' => ['business_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'plants_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'plants_ibfk_2' => ['type' => 'foreign', 'columns' => ['business_id'], 'references' => ['businesses', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-02-28 16:23:59',
                'modified' => '2020-02-28 16:23:59',
            ],
        ];
        parent::init();
    }
