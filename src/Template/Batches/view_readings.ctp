...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo"><?= __('View Readings: ' . $batch->name) ?></a>
        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-horizontal table-hover no-margin">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right text-nowrap"><?= $reading->step->stage->name ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" class="text-nowrap"><?= __('Step') ?></th>
                                                            <td class="text-right text-nowrap"><?= $reading->step->name ?></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
