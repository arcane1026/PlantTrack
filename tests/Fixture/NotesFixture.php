...
class NotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'user_key_notes' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'step_key_notes' => ['type' => 'index', 'columns' => ['step_id'], 'length' => []],
            'batch_key_notes' => ['type' => 'index', 'columns' => ['batch_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-02-28 16:24:52',
                'modified' => '2020-02-28 16:24:52',
            ],
        ];
        parent::init();
    }
