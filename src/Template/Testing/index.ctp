            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title">Testing Overview</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover text-nowrap">
                                ...
                                <?php foreach ($batches as $batch): ?>
                                    <tr class="table-<?= $testingStatuses[$batch->testing_status]['style'] ?>">
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="btn <?= $testingStatuses[$batch->testing_status]['style'] ?> btn-link" rel="tooltip" data-placement="bottom" title="" data-original-title="<?= $testingStatuses[$batch->testing_status]['name'] ?>">
