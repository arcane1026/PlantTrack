...
class NotesController extends AppController
{
    ...
    public function add()
    {
        ...
        $steps = $this->Notes->Steps->find('list', ['limit' => 200]);
        $batches = $this->Notes->Batches->find('list', ['limit' => 200]);
        $this->set(compact('note', 'users', 'steps', 'batches'));
    }
