...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Edit Step</a>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        <?= $this->Form->create($step, ['class' => 'form-horizontal']) ?>
                        <?= $this->Form->control('stage_id', ['type' => 'hidden']); ?>
                        <div class="row">
                            <label class="col-md-3 col-form-label">Growth Profile</label>
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" value="<?= $step->stage->growth_profile->name ?>" class="form-control" disabled readonly />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" value="<?= $step->stage->name ?>" class="form-control" disabled readonly />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <?= $this->Form->control('duration', ['label' => false, 'class' => 'form-control']); ?>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer ">
                            ...
                            <div class="row">
                                <div class="col-md-6 text-right">
                                    <?= $this->Form->button(__('<i class="fas fa-save"></i> Save Step'), ['class' => 'btn btn-fill btn-rose']) ?>
                                </div>
                            </div>
                        </div>
                        <?= $this->Form->end() ?>
