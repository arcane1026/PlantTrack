...
class BatchesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'growth_profile_key_batches' => ['type' => 'foreign', 'columns' => ['growth_profile_id'], 'references' => ['growth_profiles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'plant_key_batches' => ['type' => 'foreign', 'columns' => ['plant_id'], 'references' => ['plants', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'user_key_batches' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'quantity' => 1,
                'plant_date' => '2020-01-07 01:39:34',
                'harvest_date' => '2020-01-07 01:39:34',
                'watched' => 1,
                'testing_status' => 1,
                'resource_path' => 'Lorem ipsum dolor sit amet',
                'created' => '2020-01-07 01:39:34',
                'modified' => '2020-01-07 01:39:34',
            ],
        ];
        parent::init();
    }
