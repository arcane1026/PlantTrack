...
<head>
    ...
    <link href="/assets/css/material-dashboard.min.css?v=2.1.1" rel="stylesheet" /><!--     Fonts and icons     -->
    ...
    <?= $this->Html->script('material-dashboard.js?v=2.1.1') // Material Dashboard ?>
