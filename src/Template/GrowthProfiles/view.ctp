...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Growth Profile'), ['action' => 'edit', $growthProfile->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Growth Profile'), ['action' => 'delete', $growthProfile->id], ['confirm' => __('Are you sure you want to delete # {0}?', $growthProfile->id)]) ?> </li>
