...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">New Reading</a>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        <?= $this->Form->create($reading, ['class' => 'form-horizontal']) ?>
                        <div class="row">
                            <label class="col-md-3 col-form-label">Type</label>
                            <div class="col-md-9">
                                <div class="form-group">
                                    <?= $this->Form->control('name', ['label' => false, 'options' => $readingTypes, 'class' => 'form-control']); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="card-footer ">
                            ...
                            <div class="row">
                                <div class="col-md-6 text-right">
                                    <?= $this->Form->button(__('<i class="fas fa-plus"></i> Create New Note'), ['class' => 'btn btn-fill btn-rose']) ?>
                                </div>
                            </div>
                        </div>
                        <?= $this->Form->end() ?>
