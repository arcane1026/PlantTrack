...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">New Stage</a>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" value="<?= $growthProfile->name ?>" class="form-control" disabled readonly />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="card-footer ">
                            ...
                            <div class="row">
                                <div class="col-md-6 text-right">
                                    <?= $this->Form->button(__('<i class="fas fa-plus"></i> Create New Stage'), ['class' => 'btn btn-fill btn-rose']) ?>
                                </div>
                            </div>
                        </div>
                        <?= $this->Form->end() ?>
