...
class StagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stage_order' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'stage_order' => 1,
                'created' => '2020-02-28 16:24:25',
                'modified' => '2020-02-28 16:24:25',
            ],
        ];
        parent::init();
    }
